Feature: Find schemes for your business - check anchors
  ...
  Scenario: Confirm anchors on the FIND_SCHEMES page
    Given the user navigates to the "FE_TEACHING" page
  ...
  Scenario: Confirm anchors on the T_LEVELS page
  ...
  Scenario: Confirm anchors on the MULTIPLY page
  ...
  Scenario: Confirm anchors on the INTERNSHIPS page
    Given the user navigates to the "INTERNSHIPS" page
