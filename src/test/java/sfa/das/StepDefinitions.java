...
public class StepDefinitions {
    ...
    public static final List<String> ANCHOR_HOME = Arrays.asList("Apprenticeships", "Find out more about apprenticeships", "Apprenticeships");
    ...
    public static final String ANCHOR_FE_TEACHING = "Find training and employment schemes";
    ...
    static {
        ...
        schemesExploreSectionMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        ...
        schemesHomePageDefaultMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        ...
        schemesHomePagePopularityMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        ...
        schemesHomePageDurationMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        ...
        schemesHomePageCostMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        ...
        schemesComparisonPageMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_COMPARISON_PAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
    ...
    static {
        homePageToComparePageSchemeMap.put(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_COMPARISON_PAGE));
...
//todo remove         backMap.put(ANCHOR_BACK, PAGE_TITLE_SCHEME_HOME);
    ...
    public void setup(Scenario scenario) {
        ...
        findSchemesMap.put(ANCHOR_FE_TEACHING, PAGE_TITLE_SCHEME_HOME);
    ...
    public void allHomeAnchorsLinkToTheCorrectPages() throws InterruptedException {
        ...
        anchorsToRemove.add(ANCHOR_FE_TEACHING);
    ...
    //Created By me
    @Then("all FE Teaching anchors link to the correct pages")
    public void allFETeachingAnchorsLinkToTheCorrectPages() {
        genericSchemePageChecks();
        checkBackgroundColors(prisoners);
    ...
    public void allFREE_COURSESAnchorsLinkToTheCorrectPageAndAllExploreSection() throws InterruptedException {
        ...
        List<String> anchorsToRemove = new ArrayList<>();
        anchorsToRemove.add(ANCHOR_FE_TEACHING); //stays on same page
        anchorsToRemove.add(ANCHOR_HOME);
...
//                .replace(ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), "FREE_COURSES")
    ...
    public void theUserNavigatesToThePage(String destination) {
        ...
        if (destination.equals("HOME")) {
            ...
            Assert.assertEquals("Active state item should not be clickable https://dfedigital.atlassian.net/browse/CE-362", ANCHOR_HOME, activeItem.getText());

            getAnchor(ANCHOR_FE_TEACHING).click();
        ...
        switch (destination) {
            ...
            case "FIND_SCHEMES" -> {
                Assert.assertEquals("Find training and employment schemes for your business - " + findSchemesMap.get(ANCHOR_FE_TEACHING), driver.getTitle());

                Map<String, String> breadCrumbs = new LinkedHashMap<>();
                breadCrumbs.put("Home", environment.getUrl());
                assertBreadCrumbsAnchors(breadCrumbs);
                assertBreadCrumbsLi(ANCHOR_FE_TEACHING);
            }
            case "APPRENTICESHIPS" -> {
                getAnchor(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)).click();
                Assert.assertEquals("Find training and employment schemes for your business - " + schemesHomePageDefaultMap.get(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)), driver.getTitle());
                assertBreadCrumbs(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_EXPLORE_SECTION));
            }
            case "T_LEVELS" -> {
    ...
    private void assertBreadCrumbs(String breadCrumbLi) {
        Map<String, String> breadCrumbs = new LinkedHashMap<>();
        breadCrumbs.put("Home", environment.getUrl());
        breadCrumbs.put(ANCHOR_FE_TEACHING, environment.getUrl() + "schemes/");
        assertBreadCrumbsAnchors(breadCrumbs);
    ...
    static void populateCombinationsMap(Map<List<Boolean>, List<String>> combinationsMap) {
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, true, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, true, false, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, true, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(true, false, false, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, true, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, true, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, true, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, true, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, true, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, true, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, true, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, true, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, false, true, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, true, false, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, true, true, true, true)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, true, true, false, true)), Arrays.asList(ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, true, true, false, false)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, false, true, true, true)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, false, true, false, true)), Arrays.asList(ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, true, false, true, false, false)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, true, true, true, true)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, true, true, false, true)), Arrays.asList(ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, true, true, false, false)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, true, true, true)), Arrays.asList(ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, true, false, true)), Arrays.asList(ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, true, false, false)), Arrays.asList(ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, false, true, true)), Arrays.asList(ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        ...
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, false, false, true)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
        combinationsMap.put(new ArrayList<>(List.of(false, false, false, false, false, false, false, false)), Arrays.asList(ANCHOR_HOME.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_BOOTCAMPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_CARE_LEAVER_COVENANT.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_PRISONERS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_T_LEVELS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_SWAP.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_INTERNSHIPS.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_FREE_COURSES.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_MULTIPLY.get(SCHEME_ANCHOR_NAME_HOMEPAGE), ANCHOR_HTQ.get(SCHEME_ANCHOR_NAME_HOMEPAGE)));
    }
